          ...
          child: Stack(
            children: [
              Positioned(
                top: -60,
                right: -60,
                child: _bubble(180, AppColors.royalBlue.withValues(alpha: 0.25)),
              ),
              Positioned(
                bottom: 80,
                left: -70,
                              ...
                              children: [
                                MenuButton(
                                  ...
                                  onTap: () => Navigator.of(context).push(
                                    MaterialPageRoute(
                                      builder: (_) =>
                                          const GameBoardScreen(mode: 'computer'),
                                    ),
                                  ),
                                ),
                                ...
                                MenuButton(
                                  ...
                                  onTap: () => Navigator.of(context).push(
                                    MaterialPageRoute(
                                      builder: (_) =>
                                          const GameBoardScreen(mode: 'local'),
                                    ),
                                  ),
                                ),
                                const SizedBox(height: 14),
                                MenuButton(
                                  ...
                                  onTap: () => _requireAuth(
                                      () => _snack('Online lobby coming soon!')),
                                ),
                                const SizedBox(height: 14),
                                MenuButton(
                                  ...
                                  onTap: () => _requireAuth(
                                      () => _snack('Private rooms coming soon!')),
                                ),
                              ],
                            ),
